...
class FormsController extends BaseController
{
    ...
    public function actionEditFormFieldSlideoutViaCpScreen(): Response
    {
        ...
        //$layoutElementConfig = Json::decodeIf($layoutElementConfig);
        $fieldConfig = $layoutElementConfig['field'];
        ...
        //$fieldLayoutElement->setUserCondition($layoutElementConfig['userCondition'] ?? null);
        //$fieldLayoutElement->setElementCondition($layoutElementConfig['elementCondition'] ?? null);
        ...
        //\Craft::dd($userCondition->getBuilderHtml());
        ...
        return $this->asCpScreen()
            ->tabs($tabs)
            ->action('sprout-module-forms/forms/submit-form-field-slideout')
    ...
    public function actionSubmitFormFieldSlideout(): Response
    {
        // get all post data
        $this->requirePostRequest();

        $fieldSettings = Craft::$app->getRequest()->getBodyParam('fieldSettings');
