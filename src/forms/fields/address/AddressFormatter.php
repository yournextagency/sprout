...
class AddressFormatter
{
    ...
    public function getAddressFormHtml(): string
    {
        ...
        $addressLayout .= Craft::$app->getView()->renderTemplate($this->getBaseAddressFieldPath() . 'address/_components/hidden.twig', [
    ...
    public function getCountryInputHtml(bool $showCountryDropdown = true): string
    {
        ...
        return Craft::$app->getView()->renderTemplate($this->getBaseAddressFieldPath() . 'address/_components/select-country.twig', [
    ...
    public function getPostalCodeInputHtml(): string
    {
        ...
        return Craft::$app->getView()->renderTemplate($this->getBaseAddressFieldPath() . 'address/_components/text.twig', [
    ...
    private function getAdministrativeAreaInputHtml(): string
    {
        ...
        if (!empty($states)) {
            return Craft::$app->getView()->renderTemplate($this->getBaseAddressFieldPath() . 'address/_components/select.twig', [
                    'fieldClass' => 'sprout-address-onchange-country',
